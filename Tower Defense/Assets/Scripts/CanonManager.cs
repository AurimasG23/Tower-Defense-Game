...
public class CanonManager : MonoBehaviour
{
    ...
    {
        Vector3 CameraDirection = Camera.main.transform.forward * (-15);
        ...
        //boxCollider.transform.position = new Vector3(boxCollider.transform.position.x + CameraDirection.x, boxCollider.transform.position.y + CameraDirection.y, boxCollider.transform.position.z + CameraDirection.z);
